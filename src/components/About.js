...
function About() {
    ...
    const myStyleContainer = {...myStyle, ...addStyleContainer};
    ...
    return <>
        <div className="container" style={myStyle}>
            ...
            <div className="container my-3" style={{"paddingBottom" : "1vw"}}>
                <button onClick={toggleStyle} className="btn btn-primary" type="button" >{btnText}</button></div>
        </div>
    </>
}
